(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('axios'), require('tce-core'), require('plyrue'), require('tce-core/PreviewOverlay')) :
  typeof define === 'function' && define.amd ? define(['exports', 'axios', 'tce-core', 'plyrue', 'tce-core/PreviewOverlay'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.__TAILOR_CONTENT_ELEMENTS__ = global.__TAILOR_CONTENT_ELEMENTS__ || {}, global.__TAILOR_CONTENT_ELEMENTS__['tce-apivideo'] = {}), global.axios, global.tceCore, global.plyrue, global.PreviewOverlay));
}(this, (function (exports, axios, tceCore, plyrue, PreviewOverlay) { 'use strict';
  ...
  var script = {
    ...
    computed: {
      player: function player(_ref) {
        var $refs = _ref.$refs;
        return get_1($refs, 'video.player');
      },
      videoId: function videoId(_ref2) {
        var element = _ref2.element;
        return get_1(element, 'data.videoId', '');
      },
      uploadUrl: function uploadUrl(_ref3) {
        var element = _ref3.element;
        return get_1(element, 'data.uploadUrl', null);
      },
      url: function url(_ref4) {
        var element = _ref4.element;
        return get_1(element, 'data.url', '');
      },
      fileName: function fileName(_ref5) {
        var element = _ref5.element;
        return get_1(element, 'data.fileName', '');
      },
      playable: function playable(_ref6) {
        var element = _ref6.element;
        return get_1(element, 'data.playable', false);
      },
    ...
    watch: {
      ...
      videoId: function videoId() {
        ...
        return this.upload({
          ...
          var message = get_1(err, 'response.data.title', DEFAULT_ERROR_MSG);
    ...
    components: {
      ElementPlaceholder: tceCore.ElementPlaceholder,
      Plyrue: plyrue.PlyrueComponent,
      PreviewOverlay: PreviewOverlay__default['default']
    }
  };
  ...
  var __vue_render__ = function __vue_render__() {
    ...
    return _c('div', {
    ...
    }, [_vm.showPlaceholder ? _c('element-placeholder', {
      attrs: {
      ...
      attrs: {
        "show": !_vm.isDisabled && !_vm.isFocused && _vm.playable
      }
