...
import { PlyrueComponent } from 'plyrue';
...
var script = {
  ...
  computed: {
    player: function player(_ref) {
      var $refs = _ref.$refs;
      return get($refs, 'video.player');
    },
    videoId: function videoId(_ref2) {
      var element = _ref2.element;
      return get(element, 'data.videoId', '');
    },
    uploadUrl: function uploadUrl(_ref3) {
      var element = _ref3.element;
      return get(element, 'data.uploadUrl', null);
    },
    ...
    fileName: function fileName(_ref5) {
      ...
      return get(element, 'data.fileName', '');
    },
    playable: function playable(_ref6) {
      var element = _ref6.element;
      return get(element, 'data.playable', false);
    },
  ...
  watch: {
    ...
    videoId: function videoId() {
      ...
      return this.upload({
        ...
        var message = get(err, 'response.data.title', DEFAULT_ERROR_MSG);
